...
public class IntroToArrays {
	...
	public static void main(String[] args) {
		...
		int num = 10; // one variable, hold one value
		
		//1st way to declare an array
		int [] array1 = new int[5]; // 5 elements
		//syntax: 1 - data type (int), array indicator ([]), name
		//initialize syntax: 1 - new keyword, datatype (int), size ([5])
		
		// index --> 0, 1, 2, 3, 4
		// arrays = [0, 0 ,0 ,0 ,0] = elements = will print them
		
		//To access an array element, we use this form: array1[index]
		
		//be default all int arrays are initialized to 0
		System.out.println(array1[0]); //accessing the element at index 0
		System.out.println(array1[1]);
		System.out.println(array1[2]);
		System.out.println(array1[3]);
		System.out.println(array1[4]);
		//when you try to access an index that does not exits, then you get ArrayIndexOutOfBoundException
     // System.out.printLn(array1[5]); We don't have an index 5.(the highest is 4)
		...
		int[]array2;
		array2 = new int[3]; //index 0, 1, 2 = can hold 3 elements
		//Let's assign 8 to the last element of the array:
		//What is the last element index? size(=3) - 1 ---> 3-1 --> 2 (=0, 1, "2")
